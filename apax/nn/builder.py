...
class ModelBuilder:
    ...
    def build_basis_function(self) -> nn.Module:
    ...
    def build_readout(
        self, head_config: dict, is_feature_fn=False, only_use_n_layers: None | int = None
    ) -> AtomisticReadout:
    ...
    def build_scale_shift(self, scale, shift) -> PerElementScaleShift:
